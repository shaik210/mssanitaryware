...
import { accessorySeries } from "@/app/data/accessoriesData";
import accessoriesBanner from "../accessories/Assests/accesoriesBanner.jpg";
    ...
    >
      ...
      >
        {accessorySeries.map((series) => (
          <Link
            key={series.id}
            href={`/products/accessories/${series.id}`}
            style={{
              textDecoration: "none",
              color: "black",
